...
export class PrincipalPage implements ViewWillEnter {
  ...
  constructor(private navCtrl: NavController, private receiberJson: ReceiverJsonServiceService) { 
    ...
    var consumoLuz=new Servicio(null,"Luz",1,0,0,"Luz.jpg","Consumo de luz", "kW por Mes", "Monto por Consumo $");
    ...
    var enfriamiento = new Servicio(null,"Enfriamiento",4,0,0,"enfriamiento.jpg","Enfriamiento", "TRF al Mes", "-");
    ...
    this.myPyme.servicios.push(consumoRefrig);
    this.myPyme.servicios.push(consumoAireAcon);
    this.myPyme.servicios.push(consumoCalefa);
    this.myPyme.servicios.push(consumoAuto);
    this.myPyme.servicios.push(enfriamiento);
